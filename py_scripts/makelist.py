...
#Lambda_Flat_Pt
raw_list = glob.glob('/global/homes/l/lwen1990/pwg/embedding/Lambda/output_exp/auau200GeV_run11_la_exp.*.picodst.root')
...
outfile = open('../analysis/picodst_la_exp.list', 'w')
