...
#Lambda_Flat_Pt
raw_list = glob.glob('/global/homes/l/lwen1990/pwg/embedding/Lambda/output_exp/auau200GeV_run11_antila_exp.*.picodst.root')
...
outfile = open('../analysis/picodst_antila_exp.list', 'w')
